...
abstract class QuizDataSource {
  Future<List<QuizModel>> generateQuiz({required QuizEntity payload});
}

class QuizSource implements QuizDataSource {
  final Dio dio = Dio();
  @override
  Future<List<QuizModel>> generateQuiz({required QuizEntity payload}) async {
