...
class QuizScoreSheetArguments {
  final GuideDetailsEntity guideDetails;
  final int correct;
  final int total;
  QuizScoreSheetArguments({
...
class QuizScoreSheet extends StatelessWidget {
  const QuizScoreSheet({super.key});

  @override
  Widget build(BuildContext context) {
    final args =
        ModalRoute.of(context)!.settings.arguments! as QuizScoreSheetArguments;
    return PopScope(
      canPop: false,
      child: Scaffold(
        appBar: AppBar(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                    "${args.total - args.correct}".toString(),
                                    style: Theme.of(context)
                                        .textTheme
                                        .titleLarge!
                                        .copyWith(
