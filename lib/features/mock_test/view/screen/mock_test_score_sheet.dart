...
class MockTestScoreSheetArguments {
  final GuideDetailsEntity guideDetails;
  final int correct;
  final int total;
  MockTestScoreSheetArguments({
...
class MockTestScoreSheet extends StatelessWidget {
  const MockTestScoreSheet({super.key});

  @override
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)!.settings.arguments!
        as MockTestScoreSheetArguments;
    return PopScope(
      canPop: false,
      child: Scaffold(
        appBar: AppBar(
