...
class NotesPreview extends StatelessWidget {
  ...
  const NotesPreview({super.key, required this.guideDetails});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => NotesPreviewProvider(guideDetails: guideDetails),
      builder: (context, child) {
        return Consumer<NotesPreviewProvider>(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField(
                    value: provider.contentID,
                    isExpanded: true,
                    items: provider.dropdownList,
                    onChanged: (value) => provider.setContentID = value,
